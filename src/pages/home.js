...
favsTitle.innerText = "Our favourites";
...
dish1Text.innerText = "Oreo Cheesecake";
...
dish2Text.innerText = "Basque Cheesecake";
...
chefQuote.innerText = `"This is a 100% real testimonial of how good our this restaurant is according a very famous food critic that is never wrong, so come and visit or something!"`;
testimonial.appendChild(chefQuote);
const chefName = document.createElement("p");
chefName.innerText = `— Anton Ego (maybe)`;
